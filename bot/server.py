...
os.environ["LANGCHAIN_API_KEY"] = "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"
...
msseky = "8ff21051dc2a4b7e8acddf00c92ed167"
    ...
    async def get_voice(self, text: str, uid: str):
        ...
        body = f"""<speak version='1.0' xmlns='http://www.w3.org/2001/10/synthesis' 
            ...
            <voice name='zh-CN-YunzeNeural'>
                <mstts:express-as style="{self.MOODS.get(str(self.QingXu), {"voiceStyle": "default"})["voiceStyle"]}" 
        ...
        if response.status_code == 200:
            with open(os.path.join(r"E:\Documents\PycharmProjects\HM\AI_Agent\Virtual_project\bot\voice", f"{uid}.mp3"),
                      "wb") as f:
...
def add_urls(URL: str):
    ...
    qdrant = Qdrant.from_documents(
        ...
        path=r"E:\Documents\PycharmProjects\HM\AI_Agent\Virtual_project\bot\local_qdrand",
